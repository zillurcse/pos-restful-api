...
<Invoice xmlns="urn:oasis:names:specification:ubl:schema:xsd:Invoice-2" xmlns:cac="urn:oasis:names:specification:ubl:schema:xsd:CommonAggregateComponents-2" xmlns:cbc="urn:oasis:names:specification:ubl:schema:xsd:CommonBasicComponents-2" xmlns:ext="urn:oasis:names:specification:ubl:schema:xsd:CommonExtensionComponents-2" xmlns:sac="urn:oasis:names:specification:ubl:schema:xsd:SignatureAggregateComponents-2" xmlns:sbc="urn:oasis:names:specification:ubl:schema:xsd:SignatureBasicComponents-2" xmlns:sig="urn:oasis:names:specification:ubl:schema:xsd:CommonSignatureComponents-2">
                        ...
                        <ds:Signature xmlns:ds="http://www.w3.org/2000/09/xmldsig#" Id="signature">
                            <ds:SignedInfo>
                                ...
                                <ds:Reference Id="invoiceSignedData" URI="">
                                    ...
                                    <ds:DigestValue>ahpk4La17dTZvD0g1m7Szt6pTduxZsqYcHLxsYdwaAU=</ds:DigestValue>
                                </ds:Reference>
                                <ds:Reference Type="http://www.w3.org/2000/09/xmldsig#SignatureProperties" URI="#xadesSignedProperties">
                                    <ds:DigestMethod Algorithm="http://www.w3.org/2001/04/xmlenc#sha256" />
                                    <ds:DigestValue>ZGI3M2FkNGZmMWNmMGJhMWI2MjYxMzlkNDU0ZWEzMzA3NWQ1MGU4NDNkOGVhMWQ3ZTNlMWU5MTJkNTg5NzYxMg==</ds:DigestValue>
                                </ds:Reference>
                            </ds:SignedInfo>
                            <ds:SignatureValue>MEQCIHB8ZDW92Ak3TQa/eDR2VVDuGPxzcT0gMDuG86F8QKdfAiB/j8X87ectGfeF1Ja7pm011zXgkwQVy0bHnIAMdmC75Q==</ds:SignatureValue>
                            <ds:KeyInfo>
                                <ds:X509Data>
                                ...
                                <xades:QualifyingProperties xmlns:xades="http://uri.etsi.org/01903/v1.3.2#" Target="signature">
                                    <xades:SignedProperties Id="xadesSignedProperties">
                                        <xades:SignedSignatureProperties>
                                            <xades:SigningTime>2024-02-21T09:07:17</xades:SigningTime>
    ...
    <cbc:ID>141</cbc:ID>
    <cbc:UUID>2a932075-5a2f-449b-862c-ea384535</cbc:UUID>
    <cbc:IssueDate>2024-02-20</cbc:IssueDate>
    <cbc:IssueTime>11:36:00</cbc:IssueTime>
    <cbc:InvoiceTypeCode name="0100000">388</cbc:InvoiceTypeCode>
    <cbc:DocumentCurrencyCode>SAR</cbc:DocumentCurrencyCode>
    <cbc:TaxCurrencyCode>SAR</cbc:TaxCurrencyCode>
    <cac:AdditionalDocumentReference>
        <cbc:ID>ICV</cbc:ID>
        <cbc:UUID>999196</cbc:UUID>
    </cac:AdditionalDocumentReference>
    <cac:AdditionalDocumentReference>
        <cbc:ID>PIH</cbc:ID>
        <cac:Attachment>
            <cbc:EmbeddedDocumentBinaryObject mimeCode="text/plain">qekbxHmkI3ePuLN0jkBct5Cmrv7EIlLPSu+pgMayr/A=</cbc:EmbeddedDocumentBinaryObject>
        </cac:Attachment>
    </cac:AdditionalDocumentReference>
    <cac:AdditionalDocumentReference>
        <cbc:ID>QR</cbc:ID>
        <cac:Attachment>
            <cbc:EmbeddedDocumentBinaryObject mimeCode="text/plain"></cbc:EmbeddedDocumentBinaryObject>
        </cac:Attachment>
    </cac:AdditionalDocumentReference>
    <cac:Signature>
    ...
    <cac:AccountingCustomerParty>
        <cac:Party>
            ...
            <cac:PostalAddress>
                ...
                <cbc:CountrySubentity>0</cbc:CountrySubentity>
                <cac:Country>
                    <cbc:IdentificationCode>0</cbc:IdentificationCode>
                </cac:Country>
            </cac:PostalAddress>
            <cac:PartyTaxScheme>
